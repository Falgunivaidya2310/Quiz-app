...
function Quiz() {
    ...
    useEffect(() => {
        fetch("https://615c398bc298130017735ff0.mockapi.io/quiz")
        ...
        <div className="profile_page">
            <div className="col-left">
                ...
                <div className="form-group">
                    ...
                    <input type="password" name="password" id="password" placeholder="New password" defaultValue={user.password} onChange={handleChange} />
                </div>
            ...
            <div className="col-right">
                <h2>{isAdmin ? "Users" : "My Profile"}</h2>
